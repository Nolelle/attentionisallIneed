...
# dropout is the rate of dropout, a regularization technique that specifies the probabiltiy of setting to
# zero units in the nn during training.
...
class PositionalEnconding(nn.Module):
    def __init__(self, d_model: int, seq_len: int, dropout: float) -> None:
        ...
        # formula to find the positional encodings refer to paper.
